...
addToTeamCount()
{
	...
	maps\mp\gametypes\mm::debug("addToTeamCount() -> level.teamCount[\"" + self.team + "\"] = " + level.teamCount[self.team]);
...
removeFromAliveCount( disconnected )
{
	...
	maps\mp\gametypes\mm::debug("removeFromAliveCount() -> level.teamCount[\"" + self.team + "\"] = " + level.teamCount[self.team]);
